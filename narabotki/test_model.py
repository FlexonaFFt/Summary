...
def main():
    ...
    model_path = "/Users/flexonafft/Documents/Summary/updated_model/"
    base_model_name = "t5-small"  
    model, tokenizer = load_model(model_path, base_model_name)
    test_texts = [
        """Искусственный интеллект (ИИ) — это способность компьютерной системы имитировать когнитивные функции человеческого разума, 
        такие как обучение и решение проблем. Термин также может применяться к любой машине, которая демонстрирует черты, 
        связанные с человеческим разумом, такие как обучение и решение проблем. Идеальный ИИ — это система, способная рационально 
        воспринимать свое окружение и предпринимать действия, которые максимизируют ее шансы на успех. Машинное обучение, 
        форма ИИ, основана на идее, что системы могут учиться на данных, выявлять закономерности и принимать решения с минимальным 
        вмешательством человека.""",
        
        """Глубокое обучение — это подмножество машинного обучения, которое использует искусственные нейронные сети с несколькими 
        слоями для анализа различных аспектов данных. Глубокое обучение особенно полезно для обработки неструктурированных данных, 
        таких как изображения, текст и аудио. Оно достигло значительных успехов в таких областях, как компьютерное зрение, 
